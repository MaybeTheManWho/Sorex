  ...
  return (
    <section className="relative min-h-screen flex items-center pt-16">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gray-100 opacity-40" 
          style={{
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-64 h-64 p-4 minecraft-panel">
                <div className="h-full w-full bg-primary-green/20 flex items-center justify-center">
                  <p className="text-primary-green font-bold">Server Profile</p>
                </div>
              </div>
              
              {/* Floating elements */}
              <div className="absolute top-1/4 -right-8 w-16 h-16 minecraft-panel animate-float" 
              ...
              <div className="absolute bottom-1/4 -left-8 w-16 h-16 minecraft-panel animate-float" 
              ...
              <div className="absolute -bottom-8 right-1/4 w-16 h-16 minecraft-panel animate-float" 
