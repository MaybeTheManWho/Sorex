      ...
      <section className="py-20">
        <div className="container-section">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="minecraft-panel h-full w-full flex items-center justify-center">
                <div className="p-8 bg-primary-green/10 h-full w-full flex items-center justify-center">
                  <p className="text-primary-green text-xl font-bold">Our Team</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className="minecraft-panel text-center p-6"
              >
            ...
            {[
              ...
              >
                <div className={`flex flex-col md:flex-row items-center ${index % 2 === 0 ? '' : 'md:flex-row-reverse'}`}>
                  {/* Step Icon */}
                  <div className="minecraft-panel w-16 h-16 flex items-center justify-center mb-4 md:mb-0 z-10 bg-white">
                    <span className="text-2xl font-bold text-primary-green">{step.icon}</span>
                  </div>
                  
                  {/* Step Content */}
                  <div 
                    className={`minecraft-panel p-6 md:w-1/2 ${
