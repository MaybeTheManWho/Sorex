    ...
    <div className="pt-20">
      ...
      {services.map((service) => (
        <section 
          ...
          className={`py-20 ${
            service.id === 'minecraft-plugins' || service.id === 'discord-bots' 
              ? 'bg-gray-50'
              : ''
          }`}
        >
          <div className="container-section">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <h3 className="text-xl font-bold mb-4">Features & Capabilities</h3>
                  ...
                  <div className="mt-8 flex justify-center">
                    <div className="w-32 h-32 relative">
                      {service.icon ? (
                        ...
                        <div className="w-32 h-32 bg-primary-green/20 rounded-full flex items-center justify-center">
          ...
          <div className="max-w-3xl mx-auto">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
                className="minecraft-panel p-6 mb-4"
              >
